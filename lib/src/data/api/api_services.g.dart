...
class _ApiServices implements ApiServices {
  ...
  Future<GetOtpResponseModel> getOtp(
    ...
    _data.addAll(getOtpRequestModel.toJson());
    final _options = _setStreamType<GetOtpResponseModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    late GetOtpResponseModel _value;
    try {
      _value = GetOtpResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<ConfirmOtpResponseModel> confirmOtp(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(confirmOtpRequestModel.toJson());
    final _options = _setStreamType<ConfirmOtpResponseModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ConfirmOtpResponseModel _value;
    try {
      _value = ConfirmOtpResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<LoginResponseModel> login(LoginRequest loginRequestModel) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<VehiclesResponseModel> getAllVehicles() async {
    ...
    final _options = _setStreamType<VehiclesResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late VehiclesResponseModel _value;
    try {
      _value = VehiclesResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<DriverDataResponse> getDriverData() async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DriverDataResponse _value;
    try {
      _value = DriverDataResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<ChangePasswordResponesModel> changePassword(
    ...
    final _options = _setStreamType<ChangePasswordResponesModel>(Options(
      method: 'PATCH',
      headers: _headers,
      extra: _extra,
    )
